        ...
        <div className="roster-widget">
            <div className="team-roster-column">
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                    ...
                    <span className="orbitron" style={{ fontSize: '0.65rem', fontWeight: 'bold', color: 'var(--team-blue)' }}>TEAM BLUE ROSTER</span>
                </div>
            ...
            <div className="team-roster-column">
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                    ...
                    <span className="orbitron" style={{ fontSize: '0.65rem', fontWeight: 'bold', color: 'var(--team-orange)' }}>TEAM ORANGE ROSTER</span>
                </div>
                <div className="roster-list">
